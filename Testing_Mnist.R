...
test_digit(4, D_4, c(5)) # \langle R_h \rangle
test_digit(4, D_4, c(6)) # \langle R_v \rangle
test_digit(4, D_4, c(3)) # \langle R_pi \rangle
test_digit(4, D_4, c(7)) # \langle R_/ \rangle
test_digit(4, D_4, c(8)) # \langle R_\ \rangle

test_digit(4, D_4, c(6,3)) # \langle R_h, R_pi \rangle
test_digit(4, D_4, c(2,3,4)) # \langle R_pi/2 \rangle
test_digit(4, D_4, c(8,3)) # \langle R_/, R_pi \rangle

test_digit(4, D_4, c(2,6)) # D_4


#### Estimating G_max( f_5, D_4 )
...
test_digit(6, D_4, c(5)) # \langle R_h \rangle
test_digit(6, D_4, c(6)) # \langle R_v \rangle
test_digit(6, D_4, c(3)) # \langle R_pi \rangle
test_digit(6, D_4, c(7)) # \langle R_/ \rangle
test_digit(6, D_4, c(8)) # \langle R_\ \rangle

test_digit(6, D_4, c(6,3)) # \langle R_h, R_pi \rangle
test_digit(6, D_4, c(2,3,4)) # \langle R_pi/2 \rangle
test_digit(6, D_4, c(8,3)) # \langle R_/, R_pi \rangle

test_digit(6, D_4, c(2,6)) # D_4
